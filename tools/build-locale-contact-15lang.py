...
CONTACT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "h1": "Contact FITME",
        "op": "FITME is operated by solo founder <strong>Changyong Lee</strong> (South Korea).",
    ...
    "es": {
        ...
        "desc": "Contacto FITME por correo. Corea del Sur. Respuesta en 72 horas.",
        "h1": "Contacto FITME",
    ...
    "zh": {
        "title": "联系 FITME",
        "desc": "通过邮件联系 FITME。韩国。目标 72 小时内回复。",
        "h1": "联系 FITME",
    ...
    "fr": {
        "title": "Contact — FITME",
        "desc": "Contactez FITME par e-mail. Corée du Sud. Réponse sous 72 h.",
        "h1": "Contact FITME",
    ...
    "de": {
        "title": "Kontakt — FITME",
        "desc": "FITME per E-Mail kontaktieren. Südkorea. Antwort innerhalb von 72 Stunden.",
        "h1": "Kontakt FITME",
    ...
    "it": {
        ...
        "desc": "Contatta FITME via e-mail. Corea del Sud. Risposta entro 72 ore.",
        "h1": "Contatti FITME",
    ...
    "ru": {
        ...
        "desc": "Связь с FITME по e-mail. Южная Корея. Ответ в течение 72 часов.",
        "h1": "Контакты FITME",
    ...
    "ar": {
        "title": "تواصل — FITME",
        "desc": "تواصل مع FITME عبر البريد. كوريا الجنوبية. رد خلال 72 ساعة.",
        "h1": "تواصل FITME",
    ...
    "id": {
        "title": "Kontak — FITME",
        "desc": "Hubungi FITME via email. Korea Selatan. Balasan dalam 72 jam.",
        "h1": "Kontak FITME",
    ...
    "vi": {
        "title": "Liên hệ — FITME",
        "desc": "Liên hệ FITME qua email. Hàn Quốc. Phản hồi trong 72 giờ.",
        "h1": "Liên hệ FITME",

...
LOCALES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "h1": "About FITME",
        "p1": "FITME is independently built and maintained by <strong>Changyong Lee</strong>, a solo founder based in South Korea.",
    ...
    "ko": {
        ...
        "h1": "FITME 소개",
        "p1": "FITME는 대한민국에 거주하는 1인 창업가 <strong>이창용</strong>이 직접 만들고 운영합니다.",
        "why_l": "제작 계기:",
    ...
    "ja": {
        ...
        "h1": "FITMEについて",
        "p1": "FITMEは韓国を拠点とする<strong>李昌龍</strong>が一人で開発・運営しています。",
        "why_l": "制作のきっかけ:",
    ...
    "pt": {
        ...
        "desc": "A FITME é operada por Changyong Lee, fundador solo na Coreia do Sul.",
        "h1": "Sobre a FITME",
        "p1": "A FITME é criada e mantida por <strong>Changyong Lee</strong>, fundador solo na Coreia do Sul.",
    ...
    "es": {
        ...
        "desc": "FITME la crea Changyong Lee, fundador en solitario en Corea del Sur.",
        "h1": "Sobre FITME",
        "p1": "FITME la desarrolla y mantiene <strong>Changyong Lee</strong>, fundador en solitario con base en Corea del Sur.",
    ...
    "zh": {
        ...
        "desc": "FITME 由韩国的独立创始人 Changyong Lee 运营，提供体型比例教育工具。",
        "h1": "关于 FITME",
        "p1": "FITME 由居住在韩国的独立创始人 <strong>Changyong Lee</strong> 独立开发与运营。",
        "why_l": "创建原因：",
    ...
    "fr": {
        ...
        "desc": "FITME est créé par Changyong Lee, fondateur solo en Corée du Sud.",
        "h1": "À propos de FITME",
        "p1": "FITME est développé et maintenu par <strong>Changyong Lee</strong>, fondateur solo basé en Corée du Sud.",
    ...
    "de": {
        ...
        "desc": "FITME wird von Changyong Lee, Solo-Gründer in Südkorea, betrieben.",
        "h1": "Über FITME",
        "p1": "FITME wird von <strong>Changyong Lee</strong>, Solo-Gründer in Südkorea, entwickelt und betrieben.",
    ...
    "it": {
        ...
        "desc": "FITME è gestito da Changyong Lee, fondatore unico in Corea del Sud.",
        "h1": "Informazioni su FITME",
        "p1": "FITME è creato e gestito da <strong>Changyong Lee</strong>, fondatore unico con base in Corea del Sud.",
    ...
    "ru": {
        ...
        "desc": "FITME создаёт Changyong Lee, основатель-одиночка из Южной Кореи.",
        "h1": "О FITME",
        "p1": "FITME разрабатывает и ведёт <strong>Changyong Lee</strong>, основатель-одиночка из Южной Кореи.",
    ...
    "ar": {
        ...
        "desc": "يُشغّل FITME تشانغيونغ لي، مؤسس منفرد في كوريا الجنوبية.",
        "h1": "عن FITME",
        "p1": "يُطوَّر FITME ويُدار بواسطة <strong>Changyong Lee</strong>، مؤسس منفرد مقيم في كوريا الجنوبية.",
    ...
    "hi": {
        ...
        "desc": "FITME को दक्षिण कोरिया में रहने वाले स्वतंत्र संस्थापक Changyong Lee चलाते हैं।",
        "h1": "FITME के बारे में",
        "p1": "FITME को <strong>Changyong Lee</strong> ने अकेले बनाया और संचालित किया है, जो दक्षिण कोरिया में रहते हैं।",
    ...
    "th": {
        ...
        "desc": "FITME ดำเนินการโดย Changyong Lee ผู้ก่อตั้งเดี่ยวในเกาหลีใต้",
        "h1": "เกี่ยวกับ FITME",
        "p1": "FITME สร้างและดูแลโดย <strong>Changyong Lee</strong> ผู้ก่อตั้งเดี่ยวในเกาหลีใต้",
    ...
    "id": {
        ...
        "desc": "FITME dioperasikan oleh Changyong Lee, pendiri solo di Korea Selatan.",
        "h1": "Tentang FITME",
        "p1": "FITME dibuat dan dikelola oleh <strong>Changyong Lee</strong>, pendiri solo di Korea Selatan.",
    ...
    "vi": {
        ...
        "desc": "FITME do Changyong Lee, nhà sáng lập độc lập tại Hàn Quốc, vận hành.",
        "h1": "Giới thiệu FITME",
        "p1": "FITME do <strong>Changyong Lee</strong> tự xây dựng và vận hành, nhà sáng lập tại Hàn Quốc.",

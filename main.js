...
const translations = {
  ...
  en: {
    ...
    "head-guide-desc": "Use a <b>charging cable</b> for curves! Wrap it around your head, then measure its length with your phone (15cm). 3.8 phones is 57cm (avg).",
  ...
  jp: {
    ...
    "head-guide-desc": "曲線には<b>充電ケーブル</b>を使用してください！ケーブルを頭に巻きつけ、その長さをスマホ(15cm)で測ります。",
  ...
  cn: {
    ...
    "head-guide-desc": "对于曲线，请使用<b>充电线</b>！将线绕头一圈，然后用手机(15cm)测量长度。",

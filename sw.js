...
self.addEventListener('fetch', function (e) {
  ...
  /* Crawler / trust files must always hit the network (never SW cache-first). */
  if (path === '/ads.txt' || path === '/robots.txt' || path === '/sitemap.xml' || path === '/llms.txt') return;
